...
namespace CourseP3.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CourseP3.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(CourseP3.Models.ApplicationDbContext context)
        {
            ...
            //    {
            //        new StudentCourse() {CourseId = 2, StudentId = user.Id},
            //        new StudentCourse() { CourseId = 3, StudentId = user.Id},
            //        new StudentCourse() { CourseId = 4, PointEx = 70, StudentId = user.Id, Status = (int)StudentCourse.StudentCourseStatus.Done},
            //        new StudentCourse() {CourseId = 5, Point = 7, StudentId = user.Id, Status = (int)StudentCourse.StudentCourseStatus.Completed},
            //        new StudentCourse() { CourseId = 6, Point = 8, StudentId = user.Id, Status = (int)StudentCourse.StudentCourseStatus.Completed},
            //        new StudentCourse() { CourseId = 7, Point = 5, StudentId = user.Id, Status = (int)StudentCourse.StudentCourseStatus.Completed},
            //    };
            //userManager.Create(user, "password");
